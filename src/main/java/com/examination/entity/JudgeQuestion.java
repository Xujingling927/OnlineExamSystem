...
public class JudgeQuestion {
    ...
    @ApiModelProperty(name = "score",value = "题目分数",position = 5)
    private Integer score;

    @ApiModelProperty(name = "level",value = "难度等级",position = 6)
    private String level;

    @ApiModelProperty(name = "analysis",value = "题目解析",position = 7)
